...
public class EGraphOfGraph<V, E, G extends Graph<V, E>> implements EGraph<V, E> {
	 ...
	 * @param edgeOut An outgoing edge or incident edge at the current vertex. It is null at the final vertex.
	...
	public List<E> edgesListOf(V v) {
		if (graph.getType().isUndirected())
			...
			return graph.outgoingEdgesOf(v).stream().collect(Collectors.toList());
	}
